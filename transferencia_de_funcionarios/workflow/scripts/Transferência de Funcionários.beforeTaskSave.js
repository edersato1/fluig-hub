...
function EnviaEmail(numSolic) {
    ...
    try {
        ...
        var html = 
            "<h3>\
                <b>TRANSFERÊNCIA DE FUNCIONÁRIO - " + nomeFunc + " - SOLICITAÇÃO </b> \
            ...
            <div>\
                <h4\
                    <b>Obra Destino:</b> " + hAPI.getCardValue('obraDestino') + "<br>\
                </h4>\
            </div>\
        ...
        var data = {
            ...
            params: {
                ...
                subject: "[FLUIG] Transferência de Funcionário - " + nomeFunc,
                templateId: "TPL_RH_TRANSFEREFUNCIONARIO",
                dialectId: "pt_BR",
                param: {
                    "CORPO_EMAIL": html,
                    "SERVER_URL": url,
