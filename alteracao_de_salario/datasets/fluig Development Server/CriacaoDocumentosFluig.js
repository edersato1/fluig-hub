function createDataset(fields, constraints, sortFields) {
	...
	if (pasta != "" && pasta != null) {
		...
		var ParentDocumentId = 7; // Anexos OC/OS = Codigo da pasta pai onde o novo documento sera publicado
	}
	...
	try {
		...
		try {
		    ...
		    log.error("Erro ao decodificar base64: " + e.message);
